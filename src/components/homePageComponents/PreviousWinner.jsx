    ...
    return (
        <section className="w-full bg-white sm:px-14 px-10 pt-10 flex justify-center">
            <div className="lg:w-[1024px]">
                ...
                <div className="flex w-full text-[#4e4e4e] justify-between flex-wrap ">
                    <div className="flex flex-col md:flex-row w-[300px] md:w-full items-center font-chakra mt-10 mx-2">
                        ...
                        <div className="flex flex-col justify-between min-h-52">
                            ...
                            <p className="font-light">Šīs bija tiešam labas sajūtas, paldies manam sturmanim par idealu sniegumu, bez viņa mēs šeit uz pjedestāļa nestāvētu.</p>
                        </div>
                    </div>
                </div>
            </div>
